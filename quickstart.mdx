...
MCP_URL = "https://mcp-adgentic-products-308245529553.us-central1.run.app/mcp/"
...
<Warning>It is recommended to run this script using uv run for consistent dependency management and environment isolation.</Warning>
